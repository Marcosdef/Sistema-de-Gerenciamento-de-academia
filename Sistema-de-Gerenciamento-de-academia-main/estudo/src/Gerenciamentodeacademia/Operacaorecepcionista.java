...
// Botoes
        ...
        scroll.setBounds(370,20,550,430);
    ...
    public void buscarparaatualizar () {
        ...
        txtSalario.setText(String.valueOf(rece.getSalario()));
    ...
    public void atualizar() {
        ...
        rece.setSalario(Double.parseDouble(txtSalario.getText().trim()));
    ...
    public void atualizarTabela() {
        ...
        for (Recepcionista r : recepicionista) {
